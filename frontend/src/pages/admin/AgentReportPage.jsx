...
const AgentReportPage = () => {
  ...
  return (
    <div className="bg-[#F9FAFB] min-h-screen font-['Inter'] print:bg-white pb-12">
      <div className="p-6 md:p-8 space-y-8">
        ...
        <div className="flex items-center justify-between print:hidden">
          ...
          <div className="flex gap-3">
            <Button variant="outline" onClick={handlePrint} className="gap-2 border-[#E5E7EB] text-[#6B7280] hover:text-black bg-white hover:bg-gray-50">
        ...
        <Card className="border-[#E5E7EB] shadow-sm bg-white overflow-hidden">
          <div className="p-6 md:p-8 flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-[#F3F4F6]">
            <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 divide-y md:divide-y-0 md:divide-x divide-[#F3F4F6] bg-white">
            {[
              ...
              <div key={i} className="p-6 md:p-8 hover:bg-[#F9FAFB] transition-colors">
                <div className="flex items-center gap-3 mb-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <Card className="lg:col-span-2 border-[#E5E7EB] shadow-sm bg-white">
            <CardHeader className="px-6 py-4 border-b border-[#F3F4F6]">
          ...
          <Card className="border-[#E5E7EB] shadow-sm bg-white">
            ...
            <CardContent className="h-[350px] p-6 flex flex-col items-center justify-center overflow-hidden">
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <Badge variant="outline" className="text-[10px] font-bold text-[#6B7280] uppercase tracking-wider bg-white">
              {reportData.agentStudents.length} Students
            </Badge>
          </div>
          <Card className="border-[#E5E7EB] shadow-sm bg-white overflow-hidden">
            <Table>
              <TableHeader>
                <TableRow className="bg-[#F9FAFB] hover:bg-[#F9FAFB] border-b border-[#E5E7EB]">
                  <TableHead className="text-[10px] font-bold uppercase tracking-widest text-[#6B7280] py-4 pl-6">Student Name</TableHead>
                  <TableHead className="text-[10px] font-bold uppercase tracking-widest text-[#6B7280] py-4">Contact Info</TableHead>
                  <TableHead className="text-[10px] text-center font-bold uppercase tracking-widest text-[#6B7280] py-4">Pipeline Status</TableHead>
                  <TableHead className="text-[10px] text-center font-bold uppercase tracking-widest text-[#6B7280] py-4">Registration Date</TableHead>
                  <TableHead className="text-[10px] text-center font-bold uppercase tracking-widest text-[#6B7280] py-4 pr-6">Event Attribution</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                  ...
                  reportData.agentStudents.map((student) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell className="py-4 text-xs text-[#4B5563] font-medium text-center">
        ...
        {/* Footer */}
        <div className="border-t border-[#E5E7EB] pt-8 mt-8 text-center">
